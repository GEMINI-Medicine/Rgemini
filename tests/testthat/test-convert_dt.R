test_that(
  ...
  {
    date_time <- c(
      "2023-01-01 12:05", "2018-12-24 14:00",
    ...
    expect_equal(res, as.POSIXct(c(
      "2023-01-01 12:05:00", "2018-12-24 14:00",
      NA, NA, NA, NA, NA
    ), tz = "UTC"))
  }
)
...
test_that(
  ...
  {
    date_time <- c(
      "2014-01-01 12:00", "2022-01-01 02:10", "2024-01-01 12:00:30",
    ...
    expect_equal(
      res, as.POSIXct(c(
        "2014-01-01 12:00:00", "2022-01-01 02:10:00", "2024-01-01 12:00:30",
        "2017-01-01 13:12:20", "2021-02-05 00:00:00", "2019-12-05 00:00:00"
      ), tz = "UTC")
    )
  }
)
