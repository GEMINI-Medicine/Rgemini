...
plot_histograms(cohort = ipadmdad, vars = c("age", "gender", "discharge_disposition"))
```

... or specify each variable as list item containing additional attributes:
```{r, out.width = "80%", fig.align = "center"}
vars <- list(
  age = list(distribution = "normal", binwidth = 1),
  gender = list(class = "categorical", label = "Sex")
)

plot_histograms(cohort = admdad, vars = vars)
