...
knitr::include_graphics("../inst/figures/epicare_flow_2.png", dpi = 100)
```

> Example output of `episodes_of_care(db)` (mock data for illustration purposes, not real data):

```{r, echo=FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../inst/figures/epicare_out_2.png", dpi = 100)
```
...
knitr::include_graphics("../inst/figures/readmission_out_2.png", dpi = 100)
```
...
```{r, echo=FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../inst/figures/attribution_2.png", dpi = 100)
```
<br>
...
```{r, echo=FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../inst/figures/buffer_2.png", dpi = 100)
```
...
```{r, echo=FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../inst/figures/flags_diagram_2.png", dpi = 100)
```
...
knitr::include_graphics("../inst/figures/elective_2.png", dpi = 100)
```
...
```{r, echo=FALSE, out.width = "65%", fig.align = "center"}
knitr::include_graphics("../inst/figures/death_2.png", dpi = 100)
```
...
```{r, echo=FALSE, out.width = "65%", fig.align = "center"}
knitr::include_graphics("../inst/figures/maid_2.png", dpi = 100)
```
...
```{r, echo=FALSE, out.width = "65%", fig.align = "center"}
knitr::include_graphics("../inst/figures/sign-out_2.png", dpi = 100)
```
...
```{r, echo=FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../inst/figures/customReadm_fig3.png", dpi = 100)
```
...
h4.author { /* Header 4 - Author Header */
  text-align: center;
  color: black;
  font-weight: bold;
  font-family: "Georgia", serif;
...
/* Below options to control the word wrap for the display of source code and output */
pre { /* Code block - determines code spacing between lines */
    font-size: 13px;
	overflow-x: auto; 
}
...
/* button to collapse the source code and output chunks */
.showopt {
