...
Note that in this case, the number of DM patients in post-pandemic group can still be reverse-calculated, given that the total number of DM patients is 37 and the other two groups have 15 DM patients each. In this scenario we could consider removing the "Overall" column by setting `overall = FALSE`. See example in [suppressing "Overall" column](#suppress-overall-count) section.
