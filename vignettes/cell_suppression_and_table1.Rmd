...
Note that in this case, the number of DM patients in post-pandemic can still be reverse-calculated from the table above, given that the total number of DM patients is 37 and the other two groups have 15 DM patients each. In this scenario we could consider [suppressing the "Overall" column](#suppress-overall-count) by setting `overall = FALSE`.
