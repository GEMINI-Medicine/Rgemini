...
ggsave("~/GitHub/Rgemini/vignettes/figures/coverage_timeline_plot.png")
coverage$timeline_plot <- data.frame()
...
coverage$timeline_data <- coverage$timeline_data[order(hospital_num)][1:10]
...
coverage$coverage_flag_enc <- coverage$coverage_flag_enc[1:10]
...
# save timeline plot as png
ggsave("~/GitHub/Rgemini/vignettes/figures/coverage_plot.png")
coverage2$coverage_plot <- data.frame()

coverage2[[2]]$hospital_id <- NULL
setnames(coverage2[[2]], "hosp", "hospital_num")
coverage2[[2]] <- coverage2[[2]][1:10]
coverage2[[2]] <- coverage2[[2]][order(discharge_month, hospital_num)]
coverage2[[1]] <- data.table()
...
ggsave("~/GitHub/Rgemini/vignettes/figures/coverage_custom_plot1.png")
...
ggsave("~/GitHub/Rgemini/vignettes/figures/coverage_custom_plot2.png")

# save data to data folder
save(coverage, coverage2, file = "~/GitHub/Rgemini/data/dummy_data_coverage.rda")
```
```{r eval = FALSE}
