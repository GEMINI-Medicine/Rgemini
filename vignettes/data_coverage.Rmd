...
lookup_data_coverage <- data.table(
  ...
  cohort_type = c("adult", "adult", "paeds", "adult", "paeds", "adult", 
...
+ Rows where the dates are `NA` indicate hospital\*table combinations for which GEMINI does not have any data at all. This could either mean that the data are not relevant at a given site (e.g., hospital 6 does not have an ICU) or that the data could not be successfully extracted.
