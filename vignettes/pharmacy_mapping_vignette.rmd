...
```{r, eval=F, echo=F}
#code to create figure below
rxnorm_res_ex1[grepl('\\|', rxnorm_match)] %>% arrange(genc_id, row_num) %>% head() %>% mutate(genc_id = convert_to_sequence(genc_id), row_num = paste0("...", substr(row_num, 6, 7))) 
```
...
```{r, eval=F, echo=F}
# code to create figure below
rxnorm_res_ex2 %>% tail() %>% mutate(genc_id = convert_to_sequence(genc_id), row_num = paste0("...", substr(row_num, 6, 7)))
```
...
knitr::include_graphics("figures/pharmacy_mapping/prepare_pharm_for_validation/fig1_prepare_pharm_run.png", dpi = 200)
```
...
```{r, echo=FALSE, out.width = "100%", fig.align = "center", fig.cap="" }
knitr::include_graphics("figures/pharmacy_mapping/prepare_pharm_for_validation/fig5_rds_object.png", dpi = 200)
```
</div>
...
```{r, echo=FALSE, out.width = "100%", fig.align = "center", fig.cap="" }
knitr::include_graphics("figures/pharmacy_mapping/prepare_pharm_for_validation/fig10_masterfile_collection_truepos.png", dpi = 200)
```
...
```{r, echo=FALSE, out.width = "80%", fig.align = "center", fig.cap="" }
knitr::include_graphics("figures/pharmacy_mapping/prepare_pharm_for_validation/fig11_masterfile_collection_truepos_clean.png", dpi = 200)
```
...
```{r, echo=FALSE, out.width = "100%", fig.align = "center", fig.cap="" }
knitr::include_graphics("figures/pharmacy_mapping/prepare_pharm_for_validation/fig12_masterfile_collection_falseneg.png", dpi = 200)
```
...
```{r, echo=FALSE, out.width = "80%", fig.align = "center", fig.cap="" }
knitr::include_graphics("figures/pharmacy_mapping/prepare_pharm_for_validation/fig13_masterfile_collection_falseneg_clean.png", dpi = 200)
```
...
pharmacy_mapping_2 <- fread(file.path(getwd(), "vignettes/figures/pharmacy_mapping/add_validated_pharm_map/pharmacy_mapping_for_SME_validated_updated.csv"))
...
fwrite(pharmacy_mapping_2, file.path(getwd(), "vignettes/figures/pharmacy_mapping/add_validated_pharm_map/pharmacy_mapping_for_SME_validated_updated_no_drug_group.csv"))
```

```{r, eval=FALSE, echo=T}
### run the function on the newly updated file
add_validated_pharm_map(file.path(getwd(), "vignettes/figures/pharmacy_mapping/add_validated_pharm_map/pharmacy_mapping_for_SME_validated_updated_no_drug_group.csv"))
```
