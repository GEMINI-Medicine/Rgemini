...
# # 3      3   671 med_id_generic_name_raw tazocin (fk) 4.5g in 100ml ns      insulin    insulin               0        TRUE                    
# # 4      4   600   med_id_brand_name_raw                         lilly      insulin    insulin               0       FALSE                    
...
**HPC4Health users and collaborators are encouraged to contribute their mappings for inclusion in the our database, enabling reuser in future work. To prepare your mapping for database upload, please follow the requirements below.**
...
1. Analyst should format the mapping file according to the following requirements:
    ...
    + In rare cases, `rxnorm_match` may contains multiple matches separated by a pipe (e.g. "cefuroxime | vancomycin"). If the SME confirms only some of the matches, the analyst should edit `rxnorm_match` to retain only the confirmed entries.
...
2. **For HPC4Health users**:
    + Notify GEMINI team when a new validated mapping is available for upload and provide location of the formatted file.
    + The GEMINI team will assist with integrating the mapping to the master pharmacy mapping database.
...
#                 search_type                        raw_input rxnorm_match SME_confirm drug_group
# 1   med_id_generic_name_raw                  insulin regular      insulin        TRUE    insulin
# 2   med_id_generic_name_raw                insulin humulin r      insulin        TRUE    insulin
# 3   med_id_generic_name_raw    tazocin (fk) 4.5g in 100ml ns      insulin        TRUE    insulin
# 4   med_id_generic_name_raw                insulin-humulin r      insulin        TRUE    insulin
...
# 1   userjanedoe med_id_generic_name_raw          acenocoumarol acenocoumarol oral anticoagulant GEMINI-Project-Name 2024-11-01 09:30:06
# 2   userjanedoe med_id_generic_name_raw               apixaban      apixaban oral anticoagulant GEMINI-Project-Name 2024-11-01 09:30:06
# 3   userjanedoe med_id_generic_name_raw    apixaban 2.5 mg tab      apixaban oral anticoagulant GEMINI-Project-Name 2024-11-01 09:30:06
# 4   userjanedoe med_id_generic_name_raw apixaban 2.5 mg tablet      apixaban oral anticoagulant GEMINI-Project-Name 2024-11-01 09:30:06
# 5   userjanedoe med_id_generic_name_raw      apixaban 5 mg tab      apixaban oral anticoagulant GEMINI-Project-Name 2024-11-01 09:30:06
# 6   userjanedoe med_id_generic_name_raw   apixaban 5 mg tablet      apixaban oral anticoagulant GEMINI-Project-Name 2024-11-01 09:30:06
