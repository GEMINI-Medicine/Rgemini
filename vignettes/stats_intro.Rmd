...
First, we'll check data coverage. Generally, this should be performed on the **whole dataset** within the relevant study period (2018-2020), prior to applying any additional inclusion/exclusion steps.
...
```{r eval = FALSE}
# note: need to source this from this branch for now until it's been merged
