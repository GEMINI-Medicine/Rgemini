...
**Table 1 should not be used to select predictor variables for your model.** Similarly, you should not perform any other descriptive analyses (e.g., bivariate correlations between predictors and outcomes) to inform variable selection. Instead, if the goal of your analysis is to perform inference, variable selection should be informed by your conceptual framework & DAG (see section above). Although there are scenarios where data-driven variable selection may be appropriate (e.g., feature selection for predictive ML models), this should typically follow a rigorous modelling approach to avoid common pitfalls (see [here](https://onlinelibrary.wiley.com/doi/epdf/10.1111/tri.12895), [here](https://www.sciencedirect.com/science/article/abs/pii/S0895435621002146), and [here](https://www.frontiersin.org/journals/bioinformatics/articles/10.3389/fbinf.2022.927312/full) for a more detailed discussion).


## Required sample size

Finally, before we perform our main modelling approach, we should confirm that our cohort has a sufficient sample size to support the analysis. The required sample size depends on multiple factors, such as the goal of your model (inference vs. prediction), the study design (clinical trial vs. observational study), the degrees of freedom in your model, and the clinically relevant effect sizes of the predictors of interest. 
https://www.sciencedirect.com/science/article/pii/S001236922030458X

For prediction models: https://www.bmj.com/content/368/bmj.m441
