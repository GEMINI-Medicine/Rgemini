...
> **What is the effect of patients' age on clinical outcomes, in-hospital mortality, length of stay (LOS), among patients with community acquired pneumonia discharged between 2018 - 2020?**. 


## Study design

As a general first step in conducting a research study, researchers would carefully consider the study design most suitable for answering the research question. 
...
- Although analysts typically do not come up the study design themselves, knowing the fundamentals of study designs would help in effectively understanding of research proposals and communicating with PIs/researchers. 

- Below is a brief sketch of the core designs in clinical research. Check out these resources for a refresher on core study designs: [1](https://www.ncbi.nlm.nih.gov/books/NBK470342/), [2](https://doi.org/10.1016/S0140-6736(02)07283-5). Of note, although there are general core study designs, designs and their categorizations are not rigid, and there are grey areas that may not clearly distinguish one design from another.
...
knitr::include_graphics("figures/stat_vignette_study_design.png", dpi = 100)
```
...
- Clearly, the choice of study design is dependent on the nature of the data being used. 
  ...
  + The nature of routine data makes GEMINI data particularly suitable for conducting **observational studies**. Below are some example observational studies conducted using GEMINI data:
    + Retrospective: <span style='font-size:11px'> [Bai AD et al. CHEST, 2024](https://doi.org/10.1016/j.chest.2023.08.008). [McIntyre MT et al. CMAJ, 2023](https://doi.org/10.1503/cmaj.221732). [Doshi S et al. JAMA Intern Med., 2023](https://doi.org/10.1001/jamainternmed.2023.2629).</span>
...
Now that we understand different study designs and attribute of GEMINI data, let’s determine what study design would be suitable to address our research question.

- The exposure of interest is patient's age at admission. The outcomes of interest are in-hospital mortality and LOS.

- Experimental studies are not suitable for this question (impossible for researchers to manipulate the exposure variable, age). The question is observational by nature.

- The question is looking to estimate the association (magnitude and direction) between age at admission and patients’ clinical outcomes. An analytical study rather than a descriptive study is required. Since in-hospital mortality and LOS can only be known after hospital admission, the temporal relationship between exposure and outcome is implied. Therefore, our research question calls for a cohort study design, which means that researchers would assemble a cohort of patients based on characteristics at admission (e.g. community acquired pneumonia) and then follow them over time for the occurrence of outcomes. 
