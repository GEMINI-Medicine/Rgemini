...
* Added documentation for return_readmit_enc flag in `readmission()` vignette

**Function Enhancements:**
* Added option to return readmission genc_id for each time window in `readmission()` function
